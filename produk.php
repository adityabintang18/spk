  ...
  <body>
      ...
      <div class="panel panel-primary">
            ...
            <?php
				include 'configdb.php';
					if (isset($_GET['id_del'])) {
						$iddel = $_GET['id_del'];
                        $del = "DELETE FROM tbl_produk WHERE id_produk = '".$iddel."'";
						$img = "SELECT * FROM tbl_produk WHERE id_produk = '".$iddel."'";
						$ambil = mysqli_query($mysqli, $img);
		  ...
		  <div class="panel-body table-responsive">
			<a class='btn btn-primary' href='add-produk.php'> Tambah Data Produk</a>
      <a class='btn btn-primary' href='report-produk.php'> Cetak</a>
      <br /><br />
            ...
            $no = 1;
                include 'configdb.php';
                    $view = mysqli_query($mysqli, "SELECT * FROM tbl_produk");
                        while ($rows = mysqli_fetch_array($view)) { ?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><?php echo $rows['id_produk'] ;?></td>
                                <td><?php echo $rows['nama_produk'] ;?></td>
                                <td><?php echo $rows['harga_produk'] ;?></td>
                                <td style="text-align: center;"><img src="image/<?php echo $rows['photo_produk']; ?>" style="width: 120px;"></td>
                                <td>
                                <a href="edit-produk.php?id=<?php echo $rows['id_produk'];?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>
								<a href="?id_del=<?php echo $rows['id_produk'];?>" onClick="return confirm('Menghapus data ke-<?php echo $i-1;?> Alternatif <?php echo $row['alternatif'];?> ?');" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</a></td>
													</td>
    </tr>
