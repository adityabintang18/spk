  ...
  <body>
      ...
      <div class="panel panel-primary">
            ...
            <?php
				include 'configdb.php';
					if (isset($_GET['id_del'])) {
						$iddel = $_GET['id_del'];
                        $del = "DELETE FROM tbl_kategori WHERE id_kategori = '".$iddel."'";
						$img = "SELECT * FROM tbl_kategori WHERE id_kategori= '".$iddel."'";
		  ...
		  <div class="panel-body table-responsive">
			<a class='btn btn-primary' href='add-kategori.php'> Tambah Data kategori</a>
      <a class='btn btn-primary' href='report-kategori.php'> Cetak</a><br /><br />
            ...
            $no = 1;
                include 'configdb.php';
                    $view = mysqli_query($mysqli, "SELECT * FROM tbl_kategori");
                        while ($rows = mysqli_fetch_array($view)) { ?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><?php echo $rows['id_kategori'] ;?></td>
                                <td><?php echo $rows['nama_kategori'] ;?></td>
                                <td style="text-align: center;"><img src="image/<?php echo $rows['photo_kategori']; ?>" style="width: 120px;"></td>
                                <td>
                                <a href="edit-kategori.php?id=<?php echo $rows['id_kategori'];?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>
								<a href="?id_del=<?php echo $rows['id_kategori'];?>" onClick="return confirm('Menghapus data ke-<?php echo $i-1;?> Alternatif <?php echo $row['alternatif'];?> ?');" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</a></td>
													</td>
    </tr>
