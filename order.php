  ...
  <body>
      ...
      <div class="panel panel-primary">
            ...
            <?php
				include 'configdb.php';
					if (isset($_GET['id_del'])) {
						$iddel = $_GET['id_del'];
                        $del = "DELETE FROM tbl_prder WHERE id_order = '".$iddel."'";
		  ...
		  <div class="panel-body table-responsive">
			<a class='btn btn-primary' href='report-order.php'> Cetak</a><br /><br />
            ...
            $no = 1;
                include 'configdb.php';
                    $view = mysqli_query($mysqli, "SELECT * FROM tbl_order");
                        while ($rows = mysqli_fetch_array($view)) { ?>
                            <tr>
                                ...
                                <td><?php echo $rows['catatan'] ;?></td>
                                <td><?php echo $rows['nama_produk'] ;?></td>
                                <td><?php echo $rows['Status'] ;?></td>
                                <td>
                                <a href="edit-order.php?id=<?php echo $rows['id_order'];?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Selesai</a>
								<a href="?id_del=<?php echo $rows['id_order'];?>" onClick="return confirm('Menghapus data ke-<?php echo $i-1;?> Alternatif <?php echo $row['alternatif'];?> ?');" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</a></td>
													</td>
    </tr>
