        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <?php
                      ...
                      $produk = $mysqli->query("select * from tbl_produk");
											if(!$kriteria || !$produk){
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="alternatif" id="alternatif"
                                ...
                                <label for="alternatif">Alternatif</label>
                            <?php
                        $queryCat = "SELECT * FROM tbl_produk";
                        ...
                        ?>
                            ...
                            while ($data = mysqli_fetch_assoc($msqlCat)) {
                                if ($data['id_produk'] == $row['id_produk']) {
                                    echo '<option selected value="' . $data['id_produk'] . '">' . $data['nama_produk'] . '</option>';
                                } else {
                        ...
                        <div class="form-group">
                            ...
                            <!-- <label for="alternatif">C1 Ketersediaan Produk</label> -->
                            <input type="text" class="form-control" name="k1" id="alternatif"
                                placeholder="ketersediaan produk">
                        </div>
